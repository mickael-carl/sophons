BINS = \
	...
	bin/grpc-executer-darwin-arm64 \
	bin/grpc-executer-darwin-x86_64 \
	bin/grpc-executer-linux-arm64 \
	bin/grpc-executer-linux-x86_64 \
	bin/dialer \
	bin/tardiff \
	bin/docgen \
	bin/conformance
...
bin/grpc-executer-darwin-arm64: $(SRCS)
	GOOS=darwin GOARCH=arm64 go build -o $@ ./cmd/grpc-executer

bin/grpc-executer-darwin-x86_64: $(SRCS)
	GOOS=darwin GOARCH=amd64 go build -o $@ ./cmd/grpc-executer

bin/grpc-executer-linux-arm64: $(SRCS)
	GOOS=linux GOARCH=arm64 go build -o $@ ./cmd/grpc-executer

bin/grpc-executer-linux-x86_64: $(SRCS)
	GOOS=linux GOARCH=amd64 go build -o $@ ./cmd/grpc-executer
